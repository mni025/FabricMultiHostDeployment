...
presetup() {
    ...
    pushd ./../../artifacts/src/github.com/traceic/go
...
VERSION="1"
CC_SRC_PATH="./../../artifacts/src/github.com/traceic/go"
CC_NAME="traceic"
...
approveForMyOrg2() {
    ...
    peer lifecycle chaincode approveformyorg -o 35.239.225.127:7050 \
