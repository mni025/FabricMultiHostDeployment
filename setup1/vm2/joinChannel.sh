...
fetchChannelBlock() {
    ...
    peer channel fetch 0 ./channel-artifacts/$CHANNEL_NAME.block -o 35.239.225.127:7050 \
...
updateAnchorPeers() {
    setGlobalsForPeer0Org2
    # Replace localhost with your orderer's vm IP address
    peer channel update -o 35.239.225.127:7050 --ordererTLSHostnameOverride orderer.example.com \
